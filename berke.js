...
client2.on("ready", () => {
      setInterval(() => {
       let b = client2.channels.get("661280020924203008")
       let c = client2.channels.get("661280055514759178")
...
client2.login("NjYxMjUzMDUzOTM2MzA0MTcw.XgpXkg.eULjZ1o7VvKJe_NDuDSPs0gUJHs");
